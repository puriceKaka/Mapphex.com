(() => {
  ...
  const PORTAL_CATALOG = [
    { id: "branch", title: "Branch Management", href: "../branches/branch-directory.html", description: "Locations, branch teams, local operations.", features: ["Branch records", "Local teams", "Operational scope"] },
    { id: "departments", title: "Department Management", href: "../departments/departments-hub.html", description: "Department users, workflows, and approvals.", features: ["Department roles", "Approvals", "Workflows"] },
    { id: "hr", title: "HR Module", href: "../hr/hr-dashboard.html", description: "Staff records, HR reports, and workforce structure.", features: ["Shared users", "Workforce reports", "Role access"] },
    { id: "finance", title: "Finance Module", href: "../reports/reports-finance.html", description: "Finance summaries, payments, and reports.", features: ["Shared transactions", "Expense views", "Reports"] },
    ...
    { id: "inventory", title: "Inventory Module", href: "../branches/branch-inventory.html", description: "Stock, items, transfers, and availability.", features: ["Stock levels", "Transfers", "Availability"] },
    ...
    { id: "sales", title: "Sales Module", href: "../branches/branch-sales.html", description: "Sales operations, customers, and performance.", features: ["Customers", "Sales activity", "Performance"] },
    { id: "analytics", title: "Analytics Module", href: "../reports/reports-executive.html", description: "Realtime analytics, reports, and insights.", features: ["Charts", "Insights", "Activity trends"] },
    ...
    { id: "reporting", title: "Reporting Module", href: "../reports/reports-hub.html", description: "Operational, finance, and organization reports.", features: ["Operational reports", "Financial summaries", "Exports"] },
  ];
